...
class AuthenticationBloc extends Bloc<AuthenticationEvent, AuthenticationState> {
  ...
  AuthenticationBloc({
    ...
    on<AuthenticationGoogleSilentLogin>((event, emit) async {
      ...
      debugPrint('\nWARNING: AuthenticationGoogleSilentLogin event guards not set. Event will always fully execute.');
      ...
      try {
        ...
        firebaseAuth.UserCredential? _userCredential = await googleAuthRepository.googleSilentLogin();
    ...
    on<AuthenticationGoogleAuthLogin>((event, emit) async {
      ...
      try {
        ...
        // call Google Auth Repository for Google Login
        firebaseAuth.UserCredential? _userCredential = await googleAuthRepository.googleLogin();
      ...
      try {
        if(_state is AuthenticationLoggedIn) {
          ...
          if(_state.userCredential!=null) {
            await googleAuthRepository.googelLogout();
          } 
